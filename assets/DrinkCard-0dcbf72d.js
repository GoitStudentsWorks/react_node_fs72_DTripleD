...
`,y=n.div`
  ...
  gap: 8px;
  position: relative;
`,u=n.div``,j=({cocktail:e,page:t,removeCocktail:o})=>i.jsxs(l,{children:[i.jsx(s,{to:`/recipe/${e._id}`,children:i.jsx(h,{children:i.jsx(c,{children:i.jsx(m,{src:e.drinkThumb,alt:e.drink,onError:d=>{d.currentTarget.src=x}})})})}),i.jsx(u,{children:i.jsxs(f,{position:t,children:[i.jsx(s,{to:`/recipe/${e._id}`,children:i.jsx(g,{children:e.drink})}),i.jsx(w,{children:"Ingredients"})]})}),(t==="my"||t==="favorite")&&i.jsx(b,{children:e.instructions}),i.jsxs(y,{children:[(t==="my"||t==="favorite")&&i.jsx(a,{id:e._id}),(t==="my"||t==="favorite")&&i.jsx(p,{id:e._id,page:t,onClick:()=>o(e._id)})]})]});j.propTypes={page:r.string,removeCocktail:r.func,cocktail:r.object};export{j as D};
